...
# label to enter name
tk.Label(master, text="Name of the Student").grid(row=0, column=0)
...
tk.Label(master, text="Subjects").grid(row=2, column=1)
tk.Label(master, text="FLAT").grid(row=3, column=1)
tk.Label(master, text="PYTHON").grid(row=4, column=1)
tk.Label(master, text="JAVA").grid(row=5, column=1)
tk.Label(master, text="C/C++").grid(row=6, column=1)
...
tk.Label(master, text="3").grid(row=3, column=3)
tk.Label(master, text="3").grid(row=4, column=3)
